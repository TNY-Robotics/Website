export default {
    name: 'Logiciels',
    title: 'Nos logiciels et applications',
    description: 'Découvrez les logiciels pour exploiter pleinement le potentiel de nos robots : Outils de contrôle, de simulation, et bibliothèques logicielles.',
    coder: {
        title: 'TNY-Coder',
        ...
        downloadForOthers: 'Télécharger pour d\'autres plateformes'
    }
};