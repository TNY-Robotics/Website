...
:nav-buttons{left="The Plastic Covers" left-link="../leg-bl/covers" left-icon="lucide:chevron-left" right="Bottom Assembly" right-link="./bottom" right-icon="lucide:chevron-right"}
