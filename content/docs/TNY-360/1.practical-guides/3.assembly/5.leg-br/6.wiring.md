...
:nav-buttons{left="The Plastic Covers" left-link="./covers" left-icon="lucide:chevron-left" right="The Front-Right Leg" right-link="../leg-fr" right-icon="lucide:chevron-right"}