...
:nav-buttons{left="Adding the Components" left-link="./components" left-icon="lucide:chevron-left" right="Wiring Everything" right-link="./wiring" right-icon="lucide:chevron-right"}