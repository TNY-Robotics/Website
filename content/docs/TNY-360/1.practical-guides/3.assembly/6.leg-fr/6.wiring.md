...
:nav-buttons{left="The Plastic Covers" left-link="./covers" left-icon="lucide:chevron-left" right="Final Assembly" right-link="../final" right-icon="lucide:chevron-right"}