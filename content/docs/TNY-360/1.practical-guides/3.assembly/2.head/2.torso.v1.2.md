...
:nav-buttons{left="Assembling the Visor" left-link="./visor" left-icon="lucide:chevron-left" right="Finishing the Head" right-link="./final" right-icon="lucide:chevron-right"}