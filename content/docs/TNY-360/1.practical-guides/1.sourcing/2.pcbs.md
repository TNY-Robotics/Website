...
:nav-buttons{right="Soldering the PCBs" right-link="./pcb-soldering" right-icon="lucide:chevron-right" left="Sourcing the components" left-link="./components" left-icon="lucide:chevron-left"}