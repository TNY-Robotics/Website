...
:nav-buttons{left="The Paw Boards Wires" left-link="./paw-boards-wires" left-icon="lucide:chevron-left" right="Modifying the motors" right-link="../motors" right-icon="lucide:chevron-right"}