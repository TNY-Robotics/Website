...
:nav-buttons{left="Preparing the components" left-link="./preparing" left-icon="lucide:chevron-left" right="Fabrication Guide" right-link="../fabrication" right-icon="lucide:chevron-right"}