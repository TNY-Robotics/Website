...
::center
<img src="/docs/images/assembly/head/ears-final.jpg" alt="Assembled ears" class="w-2/3 rounded-lg" />
::
...
:nav-buttons{left="Finishing the Head" left-link="./final" left-icon="i-lucide-chevron-left" right="The Front-Left Leg" right-link="../leg-fl" right-icon="i-lucide-chevron-right"}