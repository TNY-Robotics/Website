...
We'll now really get into the meat of the assembly process by building our first leg : the Front-Left leg !

There's nothing hard to do here, but make sure you follow the instructions carefully to avoid making mistakes :)
...
:nav-buttons{left="The Head" left-link="../head" left-icon="i-lucide-chevron-left" right="Bottom Assembly" right-link="./bottom" right-icon="i-lucide-chevron-right"}