...
::step
#animation
<Animation src="/docs/images/assembly/leg-fr/shoulder/shoulder-place.webm" />
...
::step
#animation
<Animation src="/docs/images/assembly/leg-fr/shoulder/shoulder-twist.webm" />
...
::step
#animation
<Animation src="/docs/images/assembly/leg-fl/shoulder/horn-place.webm" flip />

#text
**Place the Servo Horn straight and aligned with the recess** of the `Shoulder (FR)` part.
...
::step
#animation
<Animation src="/docs/images/assembly/leg-fl/shoulder/horn-screw.webm" flip />
...
::step
#animation
<Animation src="/docs/images/assembly/leg-fl/shoulder/guide-wires.webm" flip />

#text
Now, **pull the Servomotor wires and Contact Switch wires** through the `Shoulder (FR)`.
...
::step
#animation
<Animation src="/docs/images/assembly/leg-fl/shoulder/servo-place.webm" flip />
...
::step
#animation
<Animation src="/docs/images/assembly/leg-fl/shoulder/servo-screw.webm" flip />
...
::step
#animation
<Animation src="/docs/images/assembly/leg-fl/shoulder/pin-place.webm" flip />

#text
Align the `Shoulder-Pin` part with the Hole on the `Torso` part and the `Shoulder (FR)` part,
...
::step
#animation
<Animation src="/docs/images/assembly/leg-fl/shoulder/top-place.webm" flip />
...
::step
#animation
<Animation src="/docs/images/assembly/leg-fl/shoulder/top-screw.webm" flip />

#text
Once the `Shoulder-Top` part is well aligned, use two `M2.5 x 6mm` screws to secure it to the `Shoulder (FR)` part.
...
::step
#animation
<Animation src="/docs/images/assembly/leg-fl/shoulder/assembly-align.webm" flip />

#text
**Align the `Leg Assembly (FR)` with the `Shoulder (FR)`**, check that the marks on either side of the joint match.

Once it's done, **Press the `Leg Assembly (FR)` on the `Shoulder (FR)`** part until it sits flush.
::
...
::step
#animation
<Animation src="/docs/images/assembly/leg-fl/shoulder/assembly-screw.webm" flip />
