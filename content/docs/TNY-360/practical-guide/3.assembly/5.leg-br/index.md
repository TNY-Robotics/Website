...
After making the back-left leg, let's now assemble the back-right leg !

This is the same process as for the back-left leg, but with their mirrored versions :)
...
Ready to make your third leg ? Let's get started !

:nav-buttons{left="The Plastic Covers" left-link="../leg-bl/covers" left-icon="i-lucide-chevron-left" right="Bottom Assembly" right-link="./bottom" right-icon="i-lucide-chevron-right"}
