...
:nav-buttons{left="The Main PCB" left-link="../pcb-soldering/main.v1.1" left-icon="i-lucide-chevron-left" right="The Buttons" right-link="./buttons" right-icon="i-lucide-chevron-right"}