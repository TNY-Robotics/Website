...
:nav-buttons{left="Preparing the components" left-link="./preparing" left-icon="i-lucide-chevron-left" right="Fabrication Guide" right-link="../fabrication" right-icon="i-lucide-chevron-right"}