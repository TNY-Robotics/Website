...
description: Learn how to source all the components, flash the firmware, and prepare for building your TNY-360 robot from scratch.
---
...
This section is designed for those who want to build their TNY-360 **from scratch**.<br>
Here, you will find detailed instructions on how to source all the necessary components, flash the firmware onto the microcontroller, and prepare for the fabrication and assembly phases.
