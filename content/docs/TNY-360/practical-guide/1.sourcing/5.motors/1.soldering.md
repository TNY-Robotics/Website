...
:nav-buttons{left="Modifying the motors" left-link="./" left-icon="i-lucide-chevron-left" right="Adding the custom PCBs" right-link="./modifying" right-icon="i-lucide-chevron-right"}