...
By checking the [OPA333 Datasheet](https://www.ti.com/lit/ds/symlink/opa333.pdf), we can find a bunch of alternatives with the same specifications and footprint (`SC-70-5`),
such as the OPA333**AIDCKR** for example, which is often in stock and available [on Mouser](https://www.mouser.fr/ProductDetail/595-OPA333AIDCKR), or [on LCSC](https://www.lcsc.com/product-detail/C44193.html).

![OPA333AIDCKR Datasheet](/docs/images/pcb/datasheet-package.jpg)
::
...
:nav-buttons{right="Soldering the PCBs" right-link="./pcb-soldering" right-icon="i-lucide-chevron-right" left="Sourcing the components" left-link="./components" left-icon="i-lucide-chevron-left"}