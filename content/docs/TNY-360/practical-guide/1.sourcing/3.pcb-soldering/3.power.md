...
::nav-buttons{left="The Paw PCB" left-link="./paw" left-icon="i-lucide-chevron-left" right="The Analog Reader" right-link="./reader" right-icon="i-lucide-chevron-right"}