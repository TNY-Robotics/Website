...
|  2  | 3-pin JST-PH Connector | Connector towards the Paw Board    |    4     |
|  3  | 3-pin Dupont Connector | Connectors for the ear motors      |    2     |
|     |                        |                                    |          |
|  4  | 0805 220Ω Resistor     | Short-circuit protection resistors |    14    |
|  5  | 0805 2.2kΩ Resistor    | Pull-up resistors for I2C bus      |    2     |
|  6  | 0805 200kΩ Resistor    | Level-shifter resistor             |    1     |
|  7  | 0805 100nF Capacitor   | Decoupling capacitor for the ICs   |    2     |
|  8  | SSOP-8 PCA9306 Chip    | 3.3V to 5V I2C level-shifter chip  |    1     |
|  9  | TSSOP-28 PCA9685 Chip  | PWM Motor Controller chip          |    1     |

#right
<img src="/docs/images/pcb/driver-v1.1.png" class="w-2/3" />
::

::info-box{title="Dupont connector type" type="warning"}
Please make sure to use **Right-Angle** Dupont connectors for the ear motors, as the straight ones won't fit properly in the torso.
::

While placing the components, make sure that:

- The JST-PH & Dupont connectors are oriented correctly, with the connector centered inside the silkscreen markings on the PCB.
...
- The PCA9306 chip is also in the correct orientation, with the little notch towards the bottom (where the brain icon is on the silkscreen).
...
::nav-buttons{left="The Analog Reader" left-link="./reader" left-icon="i-lucide-chevron-left" right="The Main PCB" right-link="./main" right-icon="i-lucide-chevron-right"}