...
Also double-check the orientation of the components (especially the step-down module) to make sure they are correct. Here's what the final result should look like:

::center
<img src="/docs/images/pcb/plug.jpg" alt="The soldered Plug PCB" class="w-2/3" />
::
...
::nav-buttons{left="Soldering the PCBs" left-link="./" left-icon="i-lucide-chevron-left" right="The Paw PCB" right-link="./paw" right-icon="i-lucide-chevron-right"}