<template>
    <NuxtLink to="/docs/tny-360" class="flex rounded-lg p-4 bg-primary/5 border-primary/50 border-2">
        ...
        <div class="flex grow flex-col justify-center items-left">
            ...
            <ProseP>See user guides to get started, program, and operate your TNY-360 robot effectively.</ProseP>
            <UButton variant="subtle" size="xl" class="w-fit mt-2" label="See the documentation" icon="lucide:arrow-right" trailing />
        </div>
    </NuxtLink>
</template>
